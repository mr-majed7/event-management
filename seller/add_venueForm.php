    ...
    <div class="container mt-4">
        ...
        <form action="add_venue.php" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="inputVenueName" name="venue_name" placeholder="Enter Venue Name" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" class="form-control" id="inputPrice" name="price" placeholder="Enter Price" required>
            </div>
            <div class="mb-3">
                <label for="inputCapacity" class="form-label">Capacity</label>
                <input type="number" class="form-control" id="inputCapacity" name="capacity" placeholder="Enter Capacity" required>
            </div>
